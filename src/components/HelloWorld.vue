    ...
    <v-container>
      ...
      <div style="width: 100%; padding-top: 5%">
        <div style="width: 37.5%; float: left">
          <p className="leftWords" style="font-size: calc(50% + 2vmin)">
        ...
        <div style="width: 25%; float: left">
          ...
          >
            <path
              ...
              :fill="[
                localFavicons ? localFavicons[index].fill : svgDefaultFill,
              ]"
              p-id="1086"
            ></path>
          </svg>
        ...
        <div style="width: 37.5%; float: left">
          <p
            ...
            style="text-align: left; font-size: calc(80% + 2vmin)"
          >
            <code style="font-size: calc(40% + 2vmin); color: #409eff">
      ...
      <div style="clear: both; padding-top: 2%" class="cardHolder">
        <v-item-group v-if="localFavicons" selected-class="bg-primary">
          <v-container>
            <v-row>
              <v-col
                v-for="localFavicon in localFavicons"
                :key="localFavicon.id"
                cols="auto"
                md="3"
              >
                ...
                <v-item v-slot="{ selectedClass, toggle }">
                  <v-card
                    ...
                    dark
                    height="100"
                    @click="toggle, cardClicked($event)"
                    :style="{ backgroundColor: localFavicon.fill }"
                    :id="localFavicon.id"
                  >
                    <div
                      ...
                      :id="localFavicon.id"
                    >
                      <!-- {{ isSelected ? "Selected" : favicon.colorName }} -->
        ...
        <v-dialog v-model="dialog" scrollable>
          <template v-slot:activator="{ props }">
            <v-btn
              ...
              size="x-large"
              v-bind="props"
              :color="localFavicons[index].fill"
            >
            </v-btn>
            <v-btn
              v-if="iconName === 'mdi-heart-multiple'"
            ...
            ></v-btn>
            <v-progress-circular
              v-if="iconName === 'Progress-circular'"
              :size="50"
              color="primary"
              indeterminate
            ></v-progress-circular>
